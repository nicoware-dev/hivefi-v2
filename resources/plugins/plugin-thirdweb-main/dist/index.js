...
var BASE_URL = "https://nebula-api.thirdweb.com";
...
var blockchainChatAction = {
  ...
  validate: async (runtime, _message) => {
    const secretKey = runtime.getSetting("THIRDWEB_SECRET_KEY") ?? process.env.THIRDWEB_SECRET_KEY;
    return Boolean(secretKey);
  },
  description: "Query blockchain data and execute transactions through natural language interaction with the Nebula API",
...
__export(actions_exports, {
  blockchainChatAction: () => blockchainChatAction
});

// src/index.ts
var thirdwebPlugin = {
  name: "PROVIDE_BLOCKCHAIN_DATA",
  description: "Search the blockchain with thirdweb Nebula for information about wallet addresses, token prices, token owners, transactions and their details.",
